...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto" style="align-items: center; ">
                ...
                <li class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
                    ...
                    <div class="d-flex mt-3 align-items-center" style="margin-left: 6px;">
                        <a href="#" class="font-weight-bold"><?php echo e(auth()->user()->name); ?></a>
                    </div>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #302E80;">
            ...
            ?>
            <a href="<?php if(Auth::user()->role_id === '1'): ?> <?php echo e(route('dashboard.admin')); ?><?php elseif(Auth::user()->role_id === '2'): ?><?php echo e(route('dashboard.manajer')); ?> <?php endif; ?>"
...
<?php /**PATH C:\laragon\www\msib-sia\resources\views/app.blade.php ENDPATH**/ ?>