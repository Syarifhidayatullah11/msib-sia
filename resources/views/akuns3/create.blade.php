    ...
    <div class="container"style="margin-left: 150px">
        <div class="row" style="width: 1500px;">
            <div class="col-md-8">
                ...
                <div class="card-header"><h4><b>Tambah Akun</b></h4></div>
                ...
                <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('akuns2.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="nama_akun2" class="col-md-4 col-form-label text-md-right">Kode Akun</label>
                            ...
                            <div class="form-group row">
                                <label for="nama_akun2" class="col-md-4 col-form-label text-md-right">Nama Akun</label>
