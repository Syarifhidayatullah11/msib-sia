...
class BukubesarController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = DB::table('transaksi')
            ...
            ->select('transaksi.tanggal', 'transaksi.deskripsi', 'akuns3.kode_akun3', 'akuns3.nama_akun3', 'detail_transaksi.debit', 'detail_transaksi.kredit', 'akuns1.nama_akun1', 'akuns3.saldo_awal')
            ->get();
